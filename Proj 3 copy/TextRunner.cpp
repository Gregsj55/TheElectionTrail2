...
int TextRunner::southChoice() {
    ...
    if(random == 0){
        ...
        cout << "You are out gettin' some BBQ, and they bring you pulled pork" << endl;
        file << "You are out gettin' some BBQ, and they bring you pulled pork" << endl;
        cout << "Say y to make the restaurant disappear" << endl;
        file << "Say y to make the restaurant disappear" << endl;
        cout << "Say n to accept the mediocre meat" << endl;
        file << "Say n to accept the mediocre meat" << endl;
    }if(random == 1){
        cout << "Howdy, Welcome to the South" << endl;
        file << "Howdy, Welcome to the South" << endl;
        cout << "You are invited to watch football" << endl;
        file << "You are invited to watch football" << endl;
        cout << "Say y because heck yeah football" << endl;
        file << "Say y because heck yeah football" << endl;
        cout << "Say n because how do football" << endl;
        ...
        cout << "Howdy, Welcome to the South" << endl;
        file << "Howdy, Welcome to the South" << endl;
        cout << "Local government wants to house your rally" << endl;
        file << "Local government wants to house your rally"<< endl;
        cout << "Say y because you'd love local support" << endl;
        file << "Say y because you'd love local support" << endl;
        cout << "Say n because you don't want their handouts" << endl;
        file << "Say n because you don't want their handouts" << endl;
        
    }if(random == 3){
        cout << "Howdy, Welcome to the South" << endl;
        file << "Howdy, Welcome to the South" << endl;
        cout << "What shape is the Earth" << endl;
        file << "What shape is the Earth" << endl;
        cout << "Say y for spicy circle" << endl;
        file << "Say y for spicy circle" << endl;
        cout << "Say n to not say your stance in fear of your supporters" << endl;
        file << "Say n to not say your stance in fear of your supporters" << endl;
        
    }if(random == 4){
        cout << "Howdy, Welcome to the South" << endl;
        file << "Howdy, Welcome to the South" << endl;
        cout << "There are hot singles in your area" << endl;
        cout << "Say y to support their college career" << endl;
        cout << "Say n because hot is a measure of temperature" << endl;
        
    }if(random == 5){
        cout << "Howdy, Welcome to the South" << endl;
        file << "Howdy, Welcome to the South" << endl;
        cout << "You find out your campaign manager has foreign ties" << endl;
        file << "You find out your campaign manager has foreign ties" << endl;
        cout << "Say y to firing him on the spot, taking the blame for it" << endl;
        file << "Say y to firing him on the spot, taking the blame for it" << endl;
        cout << "Say n to blackmailing him into working for free in fear of his life" << endl;
        file << "Say n to blackmailing him into working for free in fear of his life" << endl;
        
    }if(random == 6){
        cout << "Howdy, Welcome to the South" << endl;
        file << "Howdy, Welcome to the South" << endl;
        cout << "Is cereal a soup?" << endl;
        file << "Is cereal a soup?" << endl;
        cout << "Say y for yes" << endl;
        file << "Say y for yes" << endl;
        cout << "Say n for no" << endl;
        file << "Say n for no" << endl;
        
    }if(random == 7){
        cout << "Howdy, Welcome to the South" << endl;
        file << "Howdy, Welcome to the South" << endl;
        cout << "Your brother calls you and says he needs bail money" << endl;
        file << "Your brother calls you and says he needs bail money" << endl;
        cout << "Say y to break him out of jail instead of paying" << endl;
        file << "Say y to break him out of jail instead of paying" << endl;
        cout << "Say n because you don't have a brother..." << endl;
        file << "Say n because you don't have a brother..." << endl;        
    }if(random == 8){
        cout << "Howdy, Welcome to the South" << endl;
        file << "Howdy, Welcome to the South" << endl;
        cout << "Your supporters want to know if you like memes" << endl;
        cout << "Say y to pog" << endl;
        cout << "Say n to rage comic" << endl;
        ...
        cout << "Howdy, Welcome to the South" << endl;
        file << "Howdy, Welcome to the South" << endl;
        cout << "Your supporters want to know if you like Hamilton" << endl;
        cout << "Say y to express your love for the muiscal" << endl;
        cout << "Say n because musicals are yucky" << endl;
...
int TextRunner::southEastChoice() {
    ...
    if (random == 0) {
        ...
        cout << "Hey Sugar, welcome to the South East!" << endl;
        cout << "The port topwns are getting rowdy with gangs and rebels fighting the government." << endl;
        cout << "Say y to promise to \"Take care of it\"." << endl;
        cout << "Say n to convienently forget the question was asked" << endl;
        file << "Hey Sugar, welcome to the South East!" << endl;
        file << "The port topwns are getting rowdy with gangs and rebels fighting the government." << endl;
